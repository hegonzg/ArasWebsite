	...
	<script>
		/* Google map
      	...
      	function initialize() {
	        var mapOptions = {
	          	zoom: 14,
	          	center: new google.maps.LatLng(42.562144, -2.354912),
	          	scrollwheel: false
        	};
	    ...
	    function loadGoogleMap(){
	        ...
	        script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCEFn-m_bJSfRQRJs8tJdNv4EdXXVIkwm8&v=3.exp&sensor=false&' + 'callback=initialize';
